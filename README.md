...
* randomly pick a word from an array and present it to the user with '_' to hold the positions of the letters in the words
...
1.  Answer with a 'Y' or 'N' if you want to play the game
